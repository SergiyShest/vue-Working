...
(function(global, factory) {
    ...
    function() {
        ...
        function getInvalidTypeMessage(name, value, expectedTypes) {
            var message = "Invalid prop: type check failed for prop \"" +
                name +
                "\"." +
                " Expected " +
        ...
        function normalizeScopedSlot(normalSlots, key, fn) {
            ...
            if (fn.proxy) {
                Object.defineProperty(normalSlots,
                    key,
                    {
                        get: normalized,
                        enumerable: true,
        ...
        function createFunctionalComponent(
            ...
            if (vnode instanceof VNode) {
                ...
                for (var i = 0; i < vnodes.length; i++) {
                    res[i] =
                        cloneAndMarkFunctionalResult(vnodes[i], data, renderContext.parent, options, renderContext);
                }
                return res;
            }
        }
